...
public class RegisterDB {
    ...
    public boolean addPaymentsToDatabase(Payment obj) {
        try {
            ...
            prepSt.setInt(1, obj.getPaymentId());
            prepSt.setInt(2, obj.getBookingId());
            prepSt.setBigDecimal(3, obj.getAmount());
            prepSt.setDate(4, obj.getPaymentDate());
            prepSt.setString(5, obj.getPaymentMethod());
